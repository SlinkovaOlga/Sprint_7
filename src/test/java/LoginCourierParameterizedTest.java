...
public class LoginCourierParameterizedTest {
    ...
    public LoginCourierParameterizedTest(String login, String password, int expectedCode, String expectedMessage) {
        this.login = login;
    ...
    @Test
    @DisplayName("Negative test when logging courier")
    @Description("Test correct statusCode and error message when logging courier without one or more of required field or when entering incorrect values")
